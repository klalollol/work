...
def forward_prop(W1, b1, W2, b2, W3, b3, X):
    Z1 = W1.dot(X) + b1
    A1 = ReLU(Z1)  # Activation of the first hidden layer
    Z2 = W2.dot(A1) + b2
    A2 = ReLU(Z2)  # Activation of the second hidden layer
    Z3 = W3.dot(A2) + b3
...
W1, b1, W2, b2, W3, b3 = gradient_descent(X_train, Y_train, 0.50, 200)
